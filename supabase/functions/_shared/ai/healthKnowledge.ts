...
CONTEXTO GERENCIAL EM SAUDE:
- Indicadores operacionais (taxa de no-show, tempo de espera, laudos pendentes) refletem fluxo administrativo, nao qualidade clinica isolada.
- Especialidades comuns: clinica medica, pediatria, ginecologia, ortopedia, cardiologia, dermatologia, psiquiatria, oftalmologia.
- Status de laudo: rascunho, em revisao, liberado — laudos liberados sao visiveis ao paciente conforme politica da clinica.
- Priorizacao de fila deve respeitar criterios clinicos definidos pela gestao e legislacao (idosos, gestantes, PCD etc.).
`.trim();
